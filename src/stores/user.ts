...
interface NewPasswordVariables
{
    password: string;
}
...
export default defineStore("user", {
    ...
    actions: {
        ...
        async reset(resetVariables: ResetVariables): Promise<string>
        {
        ...
        async newPassword(newPasswordVariables: NewPasswordVariables): Promise<string>
        {
